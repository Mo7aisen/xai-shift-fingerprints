...
The JSRT, Montgomery, and Shenzhen datasets are publicly accessible from their official providers under their respective terms.
NIH ChestXray14 data require a data-use agreement (DUA) with the NIH Clinical Center and are therefore not redistributed in this repository.

A long-term archival DOI (Zenodo/Figshare) can be added after release minting.
